...
## output phenotypes
write.table(dat3, file="/mnt/work/phenotypes/phenotypes-from-data-owners/allin-endo-thyroidea-2015_14040/constructs/custom/cancer-phenome-v1.txt", quote=F, sep="\t", row.names=F)
